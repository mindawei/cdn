 ...
 * @date 2017年4月1日
 */
public final class OptimizerComplexLimitLevel0 extends OptimizerComplex{ 

	public OptimizerComplexLimitLevel0(String[] graphContent,int[] nodes, int maxMovePerRound,int maxUpdateNum, int minUpdateNum){
			super(graphContent);
