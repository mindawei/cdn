 ...
 * @date 2017年3月23日
 */
public final class GreedyOptimizerLeve3_备份 extends GreedyOptimizerMiddle {
	 ...
	 *            每轮最多移动多少次
	 */
	public GreedyOptimizerLeve3_备份(int[] nodes, int maxMovePerRound,int maxUpdateNum, int minUpdateNum) {
