 ...
 * @date 2017年4月1日
 */
public final class OptimizerMiddleLimit3 extends OptimizerMiddle2{ 
	 ...
	 *            每轮最多移动多少次
	 */
	public OptimizerMiddleLimit3(int[] nodes, int maxMovePerRound,int maxUpdateNum, int minUpdateNum
			) {
